    ...
    private static final String PHOTO_SYSTEM_PROMPT = """
            ...
            2. 약(특히 알약/캡슐)이면:
               ...
               도구 응답({"totalMatches": N, "candidates": [...]})에 따라:
                 ...
                 * totalMatches가 candidates 수와 같음 (보통 2~10건) — 후보 약명을 짧은 목록으로 제시하고 "각인/뒷면/색이 더 보이게 다시 찍어 주시면 좁힐 수 있어요." follow-up.
                 * totalMatches > candidates 수 (10개 잘림) — **후보 목록 제시 금지**. 사용자에게 시니어 친화 톤으로 자연스럽게 안내:
                   - 어떤 외형으로 검색했는지 + 몇 개가 나왔는지 한 줄로 명시 ("흰색 장방형 알약이 1,866개 검색돼서요")
                   - 좁힐 수 없다고 부드럽게 사과
